...
|------|------|------------|-------------|
| `ex_R16P` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | parameter | X direction versor. |
| `ey_R16P` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | parameter | Y direction versor. |
| `ez_R16P` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | parameter | Z direction versor. |
...
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Left hand side. |
...
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Left hand side. |
| `rhs` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Vector. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Vector. |
| `normal` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Normal of mirroring plane. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Vector. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Vector. |
| `axis` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Axis of rotation. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Vector data. |
| `unit` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Logic unit. |
| `fmt` | character(len=*) | in | optional | IO format. |
| `pos` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Position specifier. |
| `iostat` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | optional | IO error. |
...
| `rhs` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Right hand side. |
...
**Returns**: type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p))
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | The first vector. |
| `other` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Other vector. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Left hand side. |
| `rhs` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | The point from which computing the distance. |
| `pt1` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | First line point. |
| `pt2` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second line point. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | The point from which computing the distance. |
| `pt1` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | First plane point. |
| `pt2` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second plane point. |
| `pt3` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Third plane point. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `pt1` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | First face point. |
| `pt2` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second face point. |
| `pt3` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Third face point. |
...
| `pt2` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second face point. |
| `pt3` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Third face point. |
| `pt4` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Fourth face point. |
| `norm` | character(len=1) | in | optional | If 'norm' is passed as argument the normal is normalized. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Vector. |
| `pt1` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | First arc point. |
| `pt2` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second arc point. |
| `pt3` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Third arc point. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Compute the component of `lhs` parallel to `rhs`. |
| `rhs` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `axis` | type([vector_R16P](/api/src/lib/vecfor_R16P#vector-r16p)) | in |  | Axis of ratation. |
