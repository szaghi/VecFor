...
use vecfor_RPP, only : ex, ey, ez, vector
...
interface angle
   module procedure angle_R4P, angle_R8P, angle_R16P
endinterface angle

interface distance_to_line
   module procedure distance_to_line_R4P, distance_to_line_R8P, distance_to_line_R16P
endinterface distance_to_line

interface distance_to_plane
   module procedure distance_to_plane_R4P, distance_to_plane_R8P, distance_to_plane_R16P
endinterface distance_to_plane

interface distance_vectorial_to_plane
   module procedure distance_vectorial_to_plane_R4P, distance_vectorial_to_plane_R8P, distance_vectorial_to_plane_R16P
endinterface distance_vectorial_to_plane

interface face_normal3
   module procedure face_normal3_R4P, face_normal3_R8P, face_normal3_R16P
endinterface face_normal3

interface face_normal4
   module procedure face_normal4_R4P, face_normal4_R8P, face_normal4_R16P
endinterface face_normal4

interface iolen
   module procedure iolen_R4P, iolen_R8P, iolen_R16P
endinterface iolen

interface is_collinear
   module procedure is_collinear_R4P, is_collinear_R8P, is_collinear_R16P
endinterface is_collinear

interface is_concyclic
   module procedure is_concyclic_R4P, is_concyclic_R8P, is_concyclic_R16P
endinterface is_concyclic

interface mirror_matrix
   module procedure mirror_matrix_R4P, mirror_matrix_R8P, mirror_matrix_R16P
endinterface mirror_matrix

interface normalized
   module procedure normalized_R4P, normalized_R8P, normalized_R16P
endinterface normalized

interface normL2
   module procedure normL2_R4P, normL2_R8P, normL2_R16P
endinterface normL2

interface projection_onto_plane
   module procedure projection_onto_plane_R4P, projection_onto_plane_R8P, projection_onto_plane_R16P
endinterface projection_onto_plane

interface rotation_matrix
   module procedure rotation_matrix_R4P, rotation_matrix_R8P, rotation_matrix_R16P
endinterface rotation_matrix

interface sq_norm
   module procedure sq_norm_R4P, sq_norm_R8P, sq_norm_R16P
